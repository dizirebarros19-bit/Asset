            ...
            <tbody id="userTableBody" class="divide-y divide-gray-200 md:bg-white md:border md:border-gray-300">
                ...
                <?php else: ?>
                    ...
                    <tr class="hover:bg-emerald-50 transition-colors">
                        <td data-label="Username" class="px-4 py-4 font-semibold text-gray-900"><?= htmlspecialchars($u['username']) ?></td>
                    ...
                    <tr id="noResultsRow" style="display:none">
                        <td colspan="3" class="text-center py-4 text-gray-400">No matching results.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
function openEditUser(id, username, role, fName, lName){
    // Warning check: Block Manager role editing
    if (role === 'Manager') {
